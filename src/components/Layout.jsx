    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-teal-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      ...
      >
        <div className="flex flex-col h-full">
          ...
          {/* Navigation */}
          <nav className="flex-1 p-4 space-y-2 overflow-y-scroll [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
            ...
            {configNavItems?.length > 0 && (
              <div className="pt-2 !mt-4 border-t border-amber-200 dark:border-slate-700">
                <button
                  onClick={() => setConfigOpen(!configOpen)}
                  className="w-full flex items-center justify-between px-4 py-2 text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase hover:text-slate-700 dark:hover:text-slate-300 transition-colors"
