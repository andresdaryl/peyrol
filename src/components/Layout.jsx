...
const Layout = ({ children }) => {
  ...
  const adminNavItems = [...(user?.role === "superadmin" ? [{ path: "/users", icon: Users, label: "Users" }] : [])]
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-b border-slate-200 dark:border-slate-700">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-600 dark:text-slate-400">Payroll Management</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 border-t border-slate-200 dark:border-slate-700">
            ...
            {configNavItems?.length > 0 && (
              <div className="mb-2">
                ...
                >
                  ...
                  <ChevronDown className={`w-4 h-4 transition-transform duration-300 ${configOpen ? "rotate-180" : ""}`} />
                </button>
                <div className={`space-y-1 mt-1 overflow-hidden transition-[max-height] duration-500 ease-in-out ${configOpen ? "max-h-96" : "max-h-0"}`}>
            ...
            <div className="mb-2">
              ...
              <div className={`space-y-1 mt-1 overflow-hidden transition-[max-height] duration-500 ease-in-out ${settingsOpen ? "max-h-96" : "max-h-0"}`}>
