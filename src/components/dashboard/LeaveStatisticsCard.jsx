...
const LeaveStatisticsCard = ({ data, isLoading }) => {
  if (isLoading) {
    return (
      <div className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-xl rounded-2xl p-6 shadow-lg border border-slate-200 dark:border-slate-700 animate-pulse">
        ...
        <div className="p-4 bg-slate-50 dark:bg-slate-900/20 rounded-xl border-2 border-slate-200 dark:border-slate-800 mb-4">
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          <div className="p-3 bg-slate-50 dark:bg-slate-900/20 rounded-lg">
            ...
            <div className="h-5 w-8 bg-slate-200 dark:bg-slate-800 rounded mb-1" />
